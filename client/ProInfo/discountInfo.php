<?php
 include '../connection/header.php';
    $idU=$_GET['id'];
if($idU!=null){
    $select="SELECT * FROM `tbl_discount` WHERE Discount_Id =$idU";
    $shSelect=$con->query($select);
                    $willShSl=$shSelect->fetch_assoc();
           $pName=$willShSl['Discount_Name'];
           $pCode=$willShSl['Product_Code'];
      $pDescription=$willShSl['Discount_Description'];
                $pPrice=$willShSl['Discount_Price'];
