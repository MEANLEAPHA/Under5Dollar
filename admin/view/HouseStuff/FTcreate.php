...
$SQL="INSERT INTO `tbl_housestuff`(`Product_Id`, `Product_Name`, `Product_Code`, `Product_description`, `Product_Price`, `Product_Image`)
...
$idD=$_GET['id'];
$delete="DELETE FROM `tbl_housestuff` WHERE `Product_Id` = $idD ";
...
header('location:interface.php');
    ...
    if(isset($_POST['btnFTupdate'])){
        ...
        $Image=$_POST['upload'];
        $update="UPDATE `tbl_housestuff` SET `Product_Name`='$UProductName', `Product_Code`='$UProductCode',`Product_description`='$UpDescription',
