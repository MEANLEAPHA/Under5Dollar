...
$SQL="INSERT INTO `tbl_fashion`(`Product_Id`, `Product_Name`, `Product_Code`, `Product_description`, `Product_Price`, `Product_Image`)
...
$idD=$_GET['id'];
$delete="DELETE FROM `tbl_fashion` WHERE `Product_Id` = $idD ";
...
header('location:interface.php');
    ...
    if(isset($_POST['btnFTupdate'])){
        ...
        $Image=$_POST['upload'];
        $update="UPDATE `tbl_fashion` SET `Product_Name`='$UProductName', `Product_Code`='$UProductCode',`Product_description`='$UpDescription',
